...
user_query = "Cédrick Emmanuel work title and last company name"
...
- **Search**: The agent queries DuckDuckGo for the most relevant results about _"Cédrick Emmanuel work title and last company name"_.
...
```python
**Summary**:
1. Cédrick Emmanuel is a Software Developer at Insider, specializing in SaaS products. Source: useinsider.com
